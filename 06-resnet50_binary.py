...
class EyeNet:
    ...
    def predict(self):
        ...
        return accuracy, precision, recall, f1, cohen_kappa, quad_kappa, classification_report
...
if __name__ == '__main__':
    ...
    model = cnn.ResNet50_model(256, 11)
    accuracy, precision, recall, f1, cohen_kappa, quad_kappa, classification_report = cnn.predict()
   ...
   # print(model.summary())
    cnn.save_model(model_name="DR_binary_class2")
